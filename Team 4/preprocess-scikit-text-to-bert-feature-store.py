...
#    feature_group = create_or_load_feature_group(prefix, feature_group_name)
    ...
    df_train, df_holdout = train_test_split(df, test_size=holdout_percentage, stratify=df["Overall Rating"])
    ...
    df_validation, df_test = train_test_split(
        df_holdout, test_size=test_holdout_percentage, stratify=df_holdout["Overall Rating"])
